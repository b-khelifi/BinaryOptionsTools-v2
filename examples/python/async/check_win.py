...
async def main(ssid: str):
    ...
    (buy_id, _) = await api.buy(asset="EURUSD_otc", amount=1.0, time=60, check_win=False)
    (sell_id, _) = await api.sell(asset="EURUSD_otc", amount=1.0, time=60, check_win=False)
