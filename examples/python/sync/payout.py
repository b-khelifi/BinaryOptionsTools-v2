...
def main(ssid: str):
    ...
    partial_payout = api.payout(["EURUSD_otc", "EURUSD", "AEX25"]) # Returns a list of the payout for each of the passed assets in order
    print(f"Partial Payout: {partial_payout}")
    single_payout = api.payout("EURUSD_otc") # Returns the payout for the specified asset
